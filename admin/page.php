...
if(isset($_POST['form_terms'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Terms and Conditions Page Information is updated successfully.';
        
    }
    
}

if(isset($_POST['form_returns'])) {
    
    $valid = 1;

    if(empty($_POST['returns_title'])) {
        $valid = 0;
        $error_message .= 'Title can not be empty<br>';
    }

    if(empty($_POST['returns_content'])) {
        $valid = 0;
        $error_message .= 'Content can not be empty<br>';
    }

    $path = $_FILES['returns_banner']['name'];
    $path_tmp = $_FILES['returns_banner']['tmp_name'];
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            $result = $statement->fetchAll(PDO::FETCH_ASSOC);                           
            foreach ($result as $row) {
                $returns_banner = $row['returns_banner'];
                unlink('../assets/uploads/'.$returns_banner);
            }

            // updating the data
            $final_name = 'returns-banner'.'.'.$ext;
            move_uploaded_file( $path_tmp, '../assets/uploads/'.$final_name );

            // updating the database
            $statement = $pdo->prepare("UPDATE tbl_page SET returns_title=?,returns_content=?,returns_banner=?,returns_meta_title=?,returns_meta_keyword=?,returns_meta_description=? WHERE id=1");
            $statement->execute(array($_POST['returns_title'],$_POST['returns_content'],$final_name,$_POST['returns_meta_title'],$_POST['returns_meta_keyword'],$_POST['returns_meta_description']));
        } else {
            // updating the database
            $statement = $pdo->prepare("UPDATE tbl_page SET returns_title=?,returns_content=?,returns_meta_title=?,returns_meta_keyword=?,returns_meta_description=? WHERE id=1");
            $statement->execute(array($_POST['returns_title'],$_POST['returns_content'],$_POST['returns_meta_title'],$_POST['returns_meta_keyword'],$_POST['returns_meta_description']));
        }

        $success_message = 'Returns and Exchanges Page Information is updated successfully.';
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            foreach ($result as $row) {
                ...
                unlink('../assets/uploads/'.$shipping_banner);
            }
        ...
        $success_message = 'Shipping and Delivery Page Information is updated successfully.';
...
foreach ($result as $row) {
    ...
    $returns_title = $row['returns_title'];
    $returns_content = $row['returns_content'];
    $returns_banner = $row['returns_banner'];
    $returns_meta_title = $row['returns_meta_title'];
    $returns_meta_keyword = $row['returns_meta_keyword'];
    $returns_meta_description = $row['returns_meta_description'];
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_7" data-toggle="tab">Terms &amp; Conditions</a></li>
                        <li><a href="#tab_8" data-toggle="tab">Returns &amp; Exchanges</a></li>
                        <li><a href="#tab_9" data-toggle="tab">Shipping &amp; Delivery</a></li>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Content * </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="terms_content" id="editor2"><?php echo $terms_content; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Existing Banner Photo</label>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Title * </label>
                                        <div class="col-sm-5">
                                            <input class="form-control" type="text" name="returns_title" value="<?php echo $returns_title; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Content * </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="returns_content" id="editor3"><?php echo $returns_content; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Existing Banner Photo</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="../assets/uploads/<?php echo $returns_banner; ?>" class="existing-photo" style="height:80px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">New Banner Photo</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <input type="file" name="returns_banner">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Title</label>
                                        <div class="col-sm-8">
                                            <input class="form-control" type="text" name="returns_meta_title" value="<?php echo $returns_meta_title; ?>">
                                        </div>
                                    </div>             
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Keyword </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="returns_meta_keyword" style="height:100px;"><?php echo $returns_meta_keyword; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Meta Description </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="returns_meta_description" style="height:100px;"><?php echo $returns_meta_description; ?></textarea>
                                        </div>
                                    </div>                                    
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                            <button type="submit" class="btn btn-success pull-left" name="form_returns">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Page Content * </label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="shipping_content" id="editor4"><?php echo $shipping_content; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Existing Banner Photo</label>
                                        <div class="col-sm-6" style="padding-top:6px;">
                                            <img src="../assets/uploads/<?php echo $shipping_banner; ?>" class="existing-photo" style="height:80px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">New Banner Photo</label>
