                        ...
                        <div class="blog-right">
                            <div>
                                ...
                                <ul class="post-social">
                                    ...
                                    <li><i class="fa fa-tag"></i><a href="category.php?slug=<?php echo $row['category_slug']; ?>" class="badge bg-dark"><?php echo $row['category_name']; ?></a></li>
                                </ul>
                ...
                <div class="blog-sidebar">
                	<div class="theme-card">
                        ...
                        <ul class="recent-blog">
				            ...
				            foreach ($result as $row) {
				                ?>
				                <li><i class="fa fa-tag"></i> <a href="category.php?slug=<?php echo $row['category_slug']; ?>" class="badge bg-dark"><?php echo $row['category_name']; ?></a></li><br>
				                <?php
				            }
				            ?>
                        </ul>
