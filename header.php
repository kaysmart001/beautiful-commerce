...
<head>
  ...
  <link rel="icon" href="assets/uploads/<?php echo $favicon; ?>" type="image/png">
  <link rel="shortcut icon" href="assets/uploads/<?php echo $favicon; ?>" type="image/png">
...
<div class="loader-wrapper">
  <div>
    <img src="assets/uploads/<?php echo $preloader; ?>" alt="loader">
  </div>
</div>
<!-- loader end -->
            ...
            <div class="col-12">
               <div class="header-contain">
                  <div class="logo-block">
                     ...
                     <div class="brand-logo logo-sm-center"> <a href="index.php"> <img
                             src="assets/uploads/<?php echo $logo; ?>" class="img-fluid  " alt="logo">
                     </a>
                     </div>
                  </div>
                        ...
                        <li class="mobile-wishlist item-count icon-desk-none" onclick="openWishlist()">
                           ...
                           <div class="item-count-contain inverce"> 
                            ...
                            if(isset($_SESSION['wishlist_p_id'])) {
                                 echo count($_SESSION['wishlist_p_id']);
                            }else{
                              echo 0;
                            }
                            ?>
                  ...
                  <div class="category-left">
                     <div class="header-category3">
                        ...
                        <ul class="collapse-category open">
                           <li class="back-btn"><i class="fa fa-angle-left"></i> close</li>
                           <?php
                            ...
                            foreach ($result as $row) {
                              ?>
                              <li class="categoryone cat-toogle"><a href="product-category.php?id=<?php echo $row['tcat_id']; ?>&type=top-category" class="cat-title"><?php echo $row['tcat_name']; ?><span class="arrow"></span></a>
                                <ul class="collapse-two sub-collapse">
                                  ...
                                  foreach ($result1 as $row1) {
                                    ?>
                                    <li class="categorytwo cat-toogle"><a href="product-category.php?id=<?php echo $row1['mcat_id']; ?>&type=mid-category"><?php echo $row1['mcat_name']; ?><span class="arrow"></span></a>
                     ...
                     <div class="menu-block">
                        <nav id="main-nav">
                           ...
                           <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                              <li>
                                 <div class="mobile-back text-right">Close<i class="fa fa-angle-right ps-2" aria-hidden="true"></i></div>
                              </li>
                              <!--HOME-->
                              <li>
                                 <a class="dark-menu-item" href="index.php">Home</a>
                              </li>
                              <!--HOME-END-->
                              <!--menu start-->
                            <?php
                            ...
                            ?>
                            <li><a class="dark-menu-item" href="javascript:void(0)">Gallery</a>
                              <ul>
                            ...
                            <li><a href="contact.php" class="dark-menu-item"><?php echo $contact_title; ?></a></li>
                                <!--menu end-->
                            <!-- <li>
                                 <a class="dark-menu-item" href="testimonial.php">Testimonials</a>
                            </li> -->
                           </ul>
                        </nav>
                     </div>
